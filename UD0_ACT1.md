...
Reglas:
Un documento "paises" contiene varios "pais". Un "pais" tiene: "nombre", "capital", "continente", "idioma" y "poblacion". Todos los elementos dentro de "pais" son de texto simple. Detrás de un "pais" solo puede ir otro "pais" o el fin de "paises".
...
Reglas:
Un documento "biblioteca" contiene varios "libro". Un "libro" contiene: "titulo", "autor", "isbn", "paginas", "editorial", "idioma", "formato" y opcionalmente "descripcion" y "año". Todos los elementos hijos de "libro" son de texto simple. Detrás de un "libro" solo puede ir otro "libro" o el fin de "biblioteca".
